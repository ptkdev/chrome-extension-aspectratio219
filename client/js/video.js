...
window.onload = function() {
	chrome.storage.local.get(["youtube", "netflix", "primevideo", "dailymotion", "twitch", "vimeo", "vvvvid", "crunchyroll", "aspect_x", "aspect_y", "domains"], function(aspectratio_settings) {
